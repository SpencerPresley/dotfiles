...
local get_codelldb_adapter = function()
	...
	if mason_registry.is_installed("codelldb") then
		...
		local ok, install_path = pcall(function() return codelldb:get_install_path() end)
		...
		-- @diagnostic disable-next-line: udenfined-field (os_uname)
		local this_os = vim.uv.os_uname().sysname
		local liblldb_path = base_path .. (this_os == "Linux" and "/liblldb.so" or "/liblldb.dylib")
