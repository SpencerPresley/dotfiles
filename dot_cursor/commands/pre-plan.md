...
Include the content to analyze in your message when running this command. This can be:

- Pasted text (e.g., a code review, feature spec, or bug report)
- An `@` mention of a file or conversation
- A description of the task you're planning

If the input is a previous agent response, copy the relevant portions into your message.
